<%@ Page Language="VB" MasterPageFile="~/MasterPage/SSA_Principal.master" AutoEventWireup="false" CodeFile="SSA_SubTipoArticulo.aspx.vb" Inherits="Mantenimiento_SSA_SubTipoArticulo"%>
<asp:Content ID="Content1" ContentPlaceHolderID="cph" Runat="Server">
<center>
<table>
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" Text="Tipo Artículo:"></asp:Label></td>
        <td>
            <asp:DropDownList ID="ddlFiltroTipo" runat="server" Width="150px">
            </asp:DropDownList></td>
        <td>
                ...
                <ContentTemplate>
                    <asp:GridView ID="grvLista" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdSubTipoArticulo" HeaderText="Id" />
                            <asp:BoundField DataField="destipo" HeaderText="Tipo" />
...
<asp:Panel ID="pnlDetalle" runat="server" CssClass="cssTablaPanel" style="display:none">
    <table width="325">
        ...
        <tr>
            <td style="width: 85px">
                <asp:Label ID="Label2" runat="server" Text="Tipo Artículo:"></asp:Label></td>
            <td>
                <asp:DropDownList ID="ddlTipoArticulo" runat="server" Width="150px">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfvTipo" runat="server" ControlToValidate="ddlTipoArticulo"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDescripcion" runat="server" MaxLength="100" Width="200px"></asp:TextBox>
